...
const perguntas = [
    {
        enunciado: "Você sente que escolhe seu futuro com base no que quer ou no que esperam de você?",
        alternativas: [
            {
            ...
            {
                texto: "No que realmente quero.",
                afirmacao: "Desde o início, você fará suas escolhas com base no que acredita. Mesmo enfrentando dúvidas, terá clareza de que precisa viver algo que realmente te represente."
            }
        ]
    },
    {
        ...
        alternativas: [
            ...
            {
                texto: "Não, eu faria a mesma escolha.",
                afirmacao: "Você seguirá com firmeza, mesmo sem aprovação total. Essa autenticidade atrairá experiências que te transformarão, te deixando cada vez mais alinhado(a) com quem é por dentro."
            }
        ]
    },
    {
        ...
        alternativas: [
            {
                ...
                afirmacao: "A crença de que tudo precisa dar certo de primeira vai te deixar tenso(a). Cada passo será calculado, e a ideia de falhar poderá te impedir de tentar algo novo."
            },
            {
